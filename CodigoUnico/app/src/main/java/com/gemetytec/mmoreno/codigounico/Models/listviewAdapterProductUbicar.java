...
public class listviewAdapterProductUbicar extends ArrayAdapter<ModelDetalleEntradasPadre> implements View.OnClickListener{
    ...
    public listviewAdapterProductUbicar(ArrayList<com.gemetytec.mmoreno.codigounico.Models.ModelDetalleEntradasPadre> data, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.RecibidoProduct.setText(dataModel.getUbicada());

        if(dataModel.getCantidad() != dataModel.getUbicada()){

            viewHolder.CodigoProduct.setTextColor(Color.parseColor("#737373"));
            viewHolder.DescripcionProduct.setTextColor(Color.parseColor("#737373"));
            viewHolder.CantidadProduct.setTextColor(Color.parseColor("#737373"));
            viewHolder.RecibidoProduct.setTextColor(Color.parseColor("#737373"));

        }else if(dataModel.getCantidad() == dataModel.getUbicada()){
