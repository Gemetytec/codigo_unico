...
class Menu  : AppCompatActivity()  {
    ...
    fun MenuEntradas_Pantalla(view: View){
        try {
            val MenuEntradas = Intent(this,SubMenuEntradas::class.java)
            MenuEntradas.putExtra("L_User",User_Login)
            MenuEntradas.putExtra("L_IdAlmacen",almacenLoginId_Login)
            MenuEntradas.putExtra("L_LastDate",lastLoginDate_Login)
            MenuEntradas.putExtra("L_IdUser",User_Id_Login)
            startActivity(MenuEntradas)
