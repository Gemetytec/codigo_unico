...
public class listviewAdapterCodHijos extends ArrayAdapter<ModelCodigosHijosProduct> implements View.OnClickListener {


    private ArrayList<ModelCodigosHijosProduct> dataSet;
    Context mContext;
    ...
    public listviewAdapterCodHijos(ArrayList<com.gemetytec.mmoreno.codigounico.Models.ModelCodigosHijosProduct> data, Context context) {
        super(context, R.layout.listview_row_hijos_product, data);
        this.dataSet = data;
    ...
    public void onClick(View view) {
        ...
        ModelCodigosHijosProduct dataModel=(ModelCodigosHijosProduct)object;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ModelCodigosHijosProduct dataModel = getItem(position);
        // Compruebe si se está reutilizando una vista existente; de lo contrario, infle la vista
        listviewAdapterCodHijos.ViewHolder viewHolder; // ver el caché de búsqueda almacenado en la etiqueta

        final View result;

        if (convertView == null) {

            viewHolder = new listviewAdapterCodHijos.ViewHolder();
            LayoutInflater inflater = LayoutInflater.from(getContext());
            convertView = inflater.inflate(R.layout.listview_row_hijos_product, parent, false);
            ...
            viewHolder = (listviewAdapterCodHijos.ViewHolder) convertView.getTag();
            result=convertView;
        }
        ...
        if(dataModel.getEstatus().contentEquals("Entrada por validar") && !dataModel.getEstatus().contentEquals("Entrada validada")){
        ...
        }else if(dataModel.getEstatus().contentEquals("Entrada validada") && !dataModel.getEstatus().contentEquals("Entrada por validar")){
